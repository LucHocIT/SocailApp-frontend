...
const PostPage = () => {
  ...
  const commentId = searchParams.get('commentId'); // Get comment ID from URL params
  ...
  // Open PostModal automatically if commentId is provided
  useEffect(() => {
    if (post && commentId) {
  ...
  return (
    <div className={styles.pageWrapper}>
      <Container className={styles.container}>
        ...
        {/* PostModal for direct comment navigation */}
        {post && (
          <PostModal
            show={showPostModal}
